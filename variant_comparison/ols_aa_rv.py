...
if __name__ == "__main__":
    ...
    plt.savefig('/data/med-hudh/learning/linear_learning_curve_aa_rv.png')  
    plt.close()
    ...
    list1 = ['AA','linear','cv+rv','all',test_score,mse_all]
    list2 = ['AA','linear','cv+rv','carriers',test_score_carriers,mse_carriers]
    df_report = pd.DataFrame([list1,list2],columns=['Trait','Model','Variant','Group','R2','MSE'])
    df_report.to_csv('/data/med-hudh/report/linear_aa_rv.csv')
