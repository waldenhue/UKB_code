...
if __name__ == "__main__":
    ...
    list1 = ['AA','linear','cv','all',all_metrics['r2'],all_metrics['mse']]
    list2 = ['AA','linear','cv','carriers',carriers_metrics['r2'],carriers_metrics['mse']]

    ## output results
    df_report = pd.DataFrame([list1,list2],columns=['Trait','Model','Variant','Group','R2','MSE'])
    df_report.to_csv('./linear_aa_all.csv')
